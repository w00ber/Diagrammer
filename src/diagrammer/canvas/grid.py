...
def draw_grid(
    ...
    scale: float,
    *,
    minor_color: QColor | None = None,
    major_color: QColor | None = None,
) -> None:
    ...
    # Minor grid lines
    minor_pen = QPen(minor_color or GRID_LINE_COLOR, 0)  # cosmetic pen (width=0 means 1px regardless of zoom)
    major_pen = QPen(major_color or GRID_MAJOR_LINE_COLOR, 0)
